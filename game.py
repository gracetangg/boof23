...
class MenuPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        instruction_button = RoundedButton(button_pos[0], button_pos[1], self.canvas, text="Instructions", font=('Nimbus Sans', 20, "bold"), fg="#9c171a",
            command = lambda : controller.show_frame(Instructions))
        # instruction_button.place(x=button_pos[0], y=button_pos[1])
  
        play_button = RoundedButton((button_pos[0]+225), button_pos[1], self.canvas, text ="Play", font=('Nimbus Sans', 20, "bold"), fg="#9c171a",
            command = lambda : self.start_game())
        # play_button.place(x=(button_pos[0]+225), y=button_pos[1])

        leaderboard_button = RoundedButton((button_pos[0]+450), button_pos[1], self.canvas, text ="Leaderboard", font=('Nimbus Sans', 20, "bold"), fg="#9c171a",
